...
public partial class SeaBreezeWrapper
{
    ...
    [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public static extern int    seabreeze_get_api_version_string             (ref unsigned char buffer, int len);
    ...
    [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public static extern int    seabreeze_get_error_string                   (int errorCode, ref unsigned char buffer, int length); 
    ...
    [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public static extern int    seabreeze_get_serial_number                  (int index, ref int errorCode, ref unsigned char buffer, int length); 
    [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public static extern int    seabreeze_get_model                          (int index, ref int errorCode, ref unsigned char buffer, int length); 
    [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public static extern int    seabreeze_get_unformatted_spectrum           (int index, ref int errorCode, ref unsigned char buffer, int length); 
    ...
    [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public static extern int    seabreeze_get_usb_descriptor_string          (int index, ref int errorCode, int id, ref unsigned char buffer, int length);
    ...
    [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public static extern int    seabreeze_read_eeprom_slot                   (int index, ref int errorCode, int slot_number, ref unsigned char buffer, int length); 
    ...
    [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public static extern int    seabreeze_read_usb                           (int index, ref int errorCode, unsigned char endpoint, ref unsigned char buffer, int length);
    ...
    [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public static extern int    seabreeze_write_eeprom_slot                  (int index, ref int errorCode, int slot_number, ref unsigned char buffer, int length); 
    ...
    [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public static extern int    seabreeze_write_usb                          (int index, ref int errorCode, unsigned char endpoint, ref unsigned char buffer, int length); 
